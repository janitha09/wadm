defmodule WadmTest.Model.YamlJsonTest do
  ...
  @simple2_path "test/fixtures/simple2.yaml"
  ...
  describe "Testing YAML decoding" do
    setup do
      [
        ...
        simple2_yaml: YamlElixir.read_from_file!(@simple2_path)
      ]
    end
    ...
    test "Decode the simple YAML file, does the order matter", fixture do
      {:ok, app_spec} = AppSpec.from_map(fixture.simple2_yaml)
